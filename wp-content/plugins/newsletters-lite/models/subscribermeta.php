	...
	class wpmlSubscriberMeta extends wpmlDbHelper {
		...
		function validate($data = array()) {
			...
			if (!empty($data)) {
				...
				if (empty($meta_key)) { $this -> errors['meta_key'] = __('No meta key was specified', $this -> plugin_name); }
				if (empty($meta_value)) { $this -> errors['meta_value'] = __('No meta value was specified', $this -> plugin_name); }
			} else {
