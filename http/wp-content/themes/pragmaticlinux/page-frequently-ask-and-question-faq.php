                    ...
                    <div class="panel-heading" role="tab">
                        <div class="panel-title">
                            <table class="table-condensed" style="width: 100%;">
                                <tr>
                                    <td class=" faqs-title">
                                        <a role="button" data-toggle="collapse" data-parent="#faqs" href="#faq1" aria-expanded="true" aria-controls="collapseOne">
                                            What is Pragmatic linux?
                                        </a>
                                    </td>
                                    <td style="width: 50px;">
                                        <a role="button" data-toggle="collapse" data-parent="#faqs" href="#faq1" aria-expanded="true" aria-controls="collapseOne" style=" margin-left: 30px;  color:#a7a7a7;">
...
Where can I use it?
                                    ...
                                    <td style="width: 50px;">
                                        <a role="button" data-toggle="collapse" data-parent="#faqs" href="#faq2" aria-expanded="true" aria-controls="collapseOne" style=" margin-left: 30px;  color:#a7a7a7;">
                                            <i class="fa fa-plus-square-o fa-lg"></i>
                                        </a>
                                    </td>
                                </tr>
...
Why should I use Pragmatic Linux?
                                    ...
                                    <td style="width: 50px;">
                                        <a role="button" data-toggle="collapse" data-parent="#faqs" href="#faq3" aria-expanded="true" aria-controls="collapseOne" style=" margin-left: 30px;  color:#a7a7a7;">
                                            <i class="fa fa-plus-square-o fa-lg"></i>
                                        </a>
                                    </td>
                                </tr>
...
What else can I do with Pragmatic Linux?
                                    ...
                                    <td style="width: 50px;">
                                        <a role="button" data-toggle="collapse" data-parent="#faqs" href="#faq4" aria-expanded="true" aria-controls="collapseOne" style=" margin-left: 30px;  color:#a7a7a7;">
                                            <i class="fa fa-plus-square-o fa-lg"></i>
                                        </a>
                                    </td>
                                </tr>
                        ...
                        <div class="panel-title">
                            <table class="table-condensed" style="width: 100%;">
                                <tr>
                                    ...
                                    <td style="width: 50px;">
                                        <a role="button" data-toggle="collapse" data-parent="#faqs" href="#faq5" aria-expanded="true" aria-controls="collapseOne" style=" margin-left: 30px;  color:#a7a7a7;">
                                            <i class="fa fa-plus-square-o fa-lg"></i>
                                        </a>
                                    </td>
                                </tr>
