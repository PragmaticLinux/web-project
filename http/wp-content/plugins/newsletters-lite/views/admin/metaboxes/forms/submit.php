...
<div class="submitbox" id="submitpost">
	<div id="minor-publishing">
		...
		<div id="misc-publishing-actions">
			<?php /*<div class="misc-pub-section" id="previewemail_div" style="display:none;">
	...
	<div id="major-publishing-actions">
		<?php if (!empty($_GET['id'])) : ?>
			<div id="delete-action">
				<a href="<?php echo admin_url('admin.php?page=' . $this -> sections -> forms . '&method=delete&id=' . $_GET['id']); ?>" onclick="if (!confirm('<?php _e('Are you sure you want to delete this?', $this -> plugin_name); ?>')) { return false; }" class="submitdelete deletion"><?php _e('Delete Form', $this -> plugin_name); ?></a>
			</div>
		<?php endif; ?>
		<?php /*<?php if (!empty($_POST['ishistory'])) : ?>
			<div id="delete-action">
		...
		<div id="publishing-action">
			<input class="button button-primary button-large" type="submit" name="save" id="saveform" value="<?php _e('Save Form', $this -> plugin_name); ?>" />
		</div>
		<br class="clear" />
		<div style="text-align:right; margin:15px 0 5px 0;">
			<label><input style="min-width:0;" checked="checked" type="checkbox" name="continueediting" value="1" id="continueediting" /> <?php _e('Continue editing?', $this -> plugin_name); ?></label>
		</div>
	</div>
</div>